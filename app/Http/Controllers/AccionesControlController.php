...
use App\Models\AccionesControl;
use App\Http\Requests\StoreAccionesControlRequest;
use App\Http\Requests\UpdateAccionesControlRequest;
...
class AccionesControlController extends Controller
{
    public AccionesControl $model;
    public $rutaVisita = 'AccionesControl';
    public function __construct()
    {
        $this->model = new AccionesControl();
     ...
     */
    public function store(StoreAccionesControlRequest $request)
    {
        try {
     ...
     */
    public function show(AccionesControl $accionesControl)
    {
        //
    }
     ...
     */
    public function edit(AccionesControl $accionesControl)
    {
        $permiso = strtolower($this->rutaVisita);
     ...
     */
    public function update(UpdateAccionesControlRequest $request, AccionesControl $accionesControl)
    {
        try {
            $accionesControl->update($request->all());
            return ResponseService::success('Registro actualizado correctamente', $accionesControl);
        } catch (\Exception $e) {
     ...
     */
    public function destroy(AccionesControl $accionesControl)
    {
        try {
            $accionesControl->delete();
