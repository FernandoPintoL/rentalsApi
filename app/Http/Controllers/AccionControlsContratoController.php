...
use App\Http\Requests\StoreAccionControlsContratoRequest;
use App\Http\Requests\UpdateAccionControlsContratoRequest;
...
class AccionControlsContratoController extends Controller
{
    public AccionControlsContrato $model;
    public $rutaVisita = 'AccionControlsContrato';
    public function __construct()
    {
        $this->model = new AccionControlsContrato();
     ...
     */
    public function store(StoreAccionControlsContratoRequest $request)
    {
        try {
     ...
     */
    public function show(AccionControlsContrato $accionControlsContrato)
    {
        //
    }
     ...
     */
    public function edit(AccionControlsContrato $accionControlsContrato)
    {
        $permiso = strtolower($this->rutaVisita);
     ...
     */
    public function update(UpdateAccionControlsContratoRequest $request, AccionControlsContrato $accionControlsContrato)
    {
        try {
            $accionControlsContrato->update($request->all());
            return ResponseService::success('Registro actualizado correctamente', $accionControlsContrato);
        } catch (\Exception $e) {
     ...
     */
    public function destroy(AccionControlsContrato $accionControlsContrato)
    {
        try {
            $accionControlsContrato->delete();
