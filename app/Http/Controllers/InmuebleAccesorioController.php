...
use App\Models\InmuebleAccesorio;
use App\Http\Requests\StoreInmuebleAccesorioRequest;
use App\Http\Requests\UpdateInmuebleAccesorioRequest;
...
class InmuebleAccesorioController extends Controller
{
    public InmuebleAccesorio $model;
    public $rutaVisita = 'InmuebleAccesorio';
    public function __construct()
    {
        $this->model = new InmuebleAccesorio();
     ...
     */
    public function store(StoreInmuebleAccesorioRequest $request)
    {
        try {
     ...
     */
    public function show(InmuebleAccesorio $inmuebleAccesorio)
    {
        //
    }
     ...
     */
    public function edit(InmuebleAccesorio $inmuebleAccesorio)
    {
        $permiso = strtolower($this->rutaVisita);
     ...
     */
    public function update(UpdateInmuebleAccesorioRequest $request, InmuebleAccesorio $inmuebleAccesorio)
    {
        try {
            $inmuebleAccesorio->update($request->all());
            return ResponseService::success('Registro actualizado correctamente', $inmuebleAccesorio);
        } catch (\Exception $e) {
     ...
     */
    public function destroy(InmuebleAccesorio $inmuebleAccesorio)
    {
        try {
            $inmuebleAccesorio->delete();
